...
barChartColors && (options = {
    ...
    series: [{
        data: [380, 430, 450, 475, 550, 584, 780, 1100, 1220, 213]
    }],
    ...
    xaxis: {
        categories: ["CVE-2018-14574 - DJANGO EXPLOIT - HTTP (RESPONSE) - CB", "CVE-2018-14574 - DJANGO EXPLOIT - HTTP (RESPONSE) - CB", "United Kingdom", "Netherlands", "Italy", "France", "Japan", "United States", "China", "Germany"]
    }
